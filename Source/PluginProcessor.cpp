...
//==============================================================================
const String FirstProjectAudioProcessor::getName() const
{
...
const String FirstProjectAudioProcessor::getProgramName (int index)
{
    return {};
}

void FirstProjectAudioProcessor::changeProgramName (int index, const String& newName)
{
}
...
void FirstProjectAudioProcessor::processBlock (AudioBuffer<float>& buffer, MidiBuffer& midiMessages)
{
...
AudioProcessorEditor* FirstProjectAudioProcessor::createEditor()
{
    return new FirstProjectAudioProcessorEditor (*this);
}

//==============================================================================
void FirstProjectAudioProcessor::getStateInformation (MemoryBlock& destData)
{
